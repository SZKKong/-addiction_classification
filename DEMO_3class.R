...
data1[data1$CC == "HC","CC"] = 0 
data1[data1$CC == "AUD","CC"] = 1
data1[data1$CC == "IGD","CC"] = 2
data1$CC = as.factor(data1$CC)
...
#model training
lgbm <- lightgbm(params = params, train_matrix, valid, nrounds = 1000,num_class = 3)
